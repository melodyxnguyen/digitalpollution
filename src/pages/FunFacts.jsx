      ...
      <section className="section highlights-section">
        <div className="container">
          ...
          <div className="highlights-grid">
            {[
              { stat: '70%', text: 'of new AI-related articles present neutral or positive narratives — environmental impact is rarely the focus', cite: '[14]' },
              { stat: '<50%', text: 'of survey respondents correctly identify data centers as major contributors to AI\'s environmental footprint', cite: '[7]' },
              { stat: '800%', text: 'increase in attendance at major AI conferences like NeurIPS over the past decade', cite: '[14]' },
              { stat: '4 hrs', text: 'the average person spends on their phone each day — digital pollution grows with every minute online', cite: '[18]' },
            ].map((h, i) => (
